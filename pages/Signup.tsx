...
const Signup = () => {
  ...
  if (!loginStatus) {
    return (
      <>
        <div className=" bg-sky-200 h-screen sm:h-screen flex justify-center items-center md:flex">
            ...
            <div className="flex bg-white">
              ...
              <div>
                ...
                <div>
                  {/* welcome */}
                  <div>
                    <p className="font-mono text-2xl text-center font-bold text-blue-600 align-top animate-bounce scale-125">Signup</p>
                    <p className="font-mono text-2xl text-center font-bold align-top scale-75">Create an Account</p>
                  </div>
                  {/* Form */}
                  ...
                  /> */}
                      ...
                      {errors.password && errors.password.type === "minLength" && (
                        <p className="text-red-600 ">please enter atleast 5 characters</p>
                      )}
                    </div>
                    <div className="text-center pt-2">
                      <input className="pl-4 border-2"
                  ...
                  /> */}
                    ...
                    <div className="pt-2">
                      <div className="text-white bg-gradient-to-r from-purple-500 to-white rounded-2xl border-none shadow-lg w-full justify-center items-center font-bold">
                        {" "}
                  ...
                  <button className="w-full" onClick={handleGoogleSignup}><img src="img/Login_With_Google.png" className="w-60 h-10" /></button>

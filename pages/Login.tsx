        ...
        <div className="flex bg-white">
          ...
          <div>
            ...
            <div>
              {/* welcome */}
              <div>
                <p className="font-mono text-2xl text-center font-bold text-blue-600 align-top animate-bounce scale-125">Login</p>
              </div>
              {/* Form */}
              ...
              {/* <div className="text-white bg-gradient-to-r from-gray-600 to-white rounded-2xl border-none shadow-lg w-full justify-center items-center font-bold"> */}
               <div>
                  <button className="w-full" onClick={handleGoogleLogin}><img src="img/Login_With_Google.png" className="w-60 h-10"/></button>
              </div>
              <div className="pt-4">
                <p>
